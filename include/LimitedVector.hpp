...
template < typename ValT >
ddl::LimitedVector< ValT >::LimitedVector(const sf::Vector2< ValT > & vec,
 const sf::Vector2< ValT > & abslimit) noexcept:
  vec_(vec),
  abslimit_(abslimit)
{}
...
template < typename ValT >
ddl::LimitedVector< ValT > & ddl::LimitedVector< ValT >::operator+=(
 const sf::Vector2< ValT > & vec) noexcept
{
