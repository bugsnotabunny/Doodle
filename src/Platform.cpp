...
namespace
{
  ...
  {
    static const std::vector< float > shifts = { ddl::gameWidth / 2, ddl::gameWidth / 3 * 2 };
    static const std::vector< sf::Vector2f > speedLimits = { { 50, 0 }, { 125, 0 } };
    static const std::vector< sf::Vector2f > accelerations = { { 50, 0 }, { 125, 0 } };

    return std::make_unique< ddl::Platform >(ddl::MovingPlatform{ pos,
     chooseRandom(shifts),
